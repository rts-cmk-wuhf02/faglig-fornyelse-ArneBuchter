document.addEventListener('DOMContentLoaded', function() {
    ...
    const meta = '';
    const referencer = '2kat8VT1BaUzx9LDK9QlwA';
    ...
    .then(data => {
        data.items.forEach(element => {
            ...
            console.log(element)
            if(element.sys.id === referencer){

                let heading = document.querySelector('.reference__heading')
                let text = document.querySelector('.reference__text')
